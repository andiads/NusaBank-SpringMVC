...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2020 at 01:46 PM
...
CREATE TABLE `nasabah` (
  ...
  `username_nasabah` varchar(60) DEFAULT NULL,
  `password_nasabah` varchar(60) DEFAULT NULL,
  `tgl_pembuatan` datetime DEFAULT NULL,
  `id_rekening` int(16) DEFAULT NULL,
...
(2, 'Dudung', '12345678', NULL, 'Jkt', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0),
...
(17, 'SpringBoot', '03040304', NULL, 'Osaka, Japan', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
--
ALTER TABLE `nasabah`
  MODIFY `id_nasabah` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
